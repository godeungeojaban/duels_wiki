...
function renderLocalDocument(doc,localId){
  ...
  $('#editBtn').onclick=()=>startLocalEdit(doc,localId);$('#localListBtn').onclick=showLocalDocumentsModal;
}
...
function startLocalEdit(doc,localId){
  ...
  $('#viewPage').classList.add('hidden');$('#editPage').classList.remove('hidden');
