...
@media(max-width:420px){.duels-character-card{max-width:100%}}.duels-table-component{--duels-table-base-width:400px;--duels-table-border:#2a4a6a;display:block;position:relative;width:max-content;min-width:min(var(--duels-table-base-width),100%);max-width:none;margin:6px 0}.duels-table-scroll{display:block;overflow:visible;max-width:none}.duels-table{border-collapse:collapse;table-layout:auto;width:max-content;min-width:var(--duels-table-base-width);background:#091019;color:#b8c7d3;font-size:12px;line-height:1.35}.duels-table td{box-sizing:border-box;height:29px;padding:5px 8px;border:1px solid var(--duels-table-border);vertical-align:middle;text-align:left;white-space:nowrap;overflow:visible}@media(max-width:720px){.duels-table-component{max-width:100%}.duels-table-scroll{max-width:100%;overflow-x:auto}}
