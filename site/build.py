...
.footnote-ref{color:#65c6ff;text-decoration:none;font-weight:700;font-size:.82em;white-space:nowrap}.footnote-ref:hover{text-decoration:underline;text-shadow:0 0 8px #4af8}.footnotes{margin:42px 0 8px;padding-top:16px;border-top:1px solid #29435c}.footnotes-head{display:flex;align-items:center;gap:10px;margin-bottom:12px}.footnotes-head h2{margin:0;color:#d9e7f3;font-size:20px;line-height:1.3}.footnotes-kicker{font-size:9px;letter-spacing:.18em;color:#4f7895;border:1px solid #28465f;padding:2px 5px}.footnote-row{display:grid;grid-template-columns:46px minmax(0,1fr);gap:8px;align-items:start;padding:8px 0;border-bottom:1px solid #162a3b}.footnote-number{color:#68c7ff;font-size:12px;font-weight:700;padding-top:4px;font-variant-numeric:tabular-nums}.footnote-content>p:first-child{margin-top:0}.footnote-content>p:last-child{margin-bottom:0}@media(max-width:720px){.nav-toggle{display:inline-block;color:#adf}.layout{display:block}.sidebar{position:fixed;left:0;top:58px;bottom:0;width:min(86vw,300px);height:auto;z-index:45;transform:translateX(-102%);transition:transform .18s ease;box-shadow:8px 0 24px #000b}.sidebar.open{transform:translateX(0)}.page{margin:12px 8px 50px;padding:20px 16px}h1{font-size:27px}.top{padding:0 10px}.top a{font-size:17px}}
...
function show(a){var t=target(a);if(!t)return;clearTimeout(hideTimer);var p=ensure(),body=t.querySelector('.footnote-content'),n=(a.textContent||'').trim();p.querySelector('.footnote-popover-label').textContent='각주 '+n;p.querySelector('.footnote-popover-body').innerHTML=body?body.innerHTML:'<p>내용이 없습니다.</p>';if(active)active.classList.remove('footnote-ref-active');active=a;a.classList.add('footnote-ref-active');p.classList.remove('hidden');position(a)}
