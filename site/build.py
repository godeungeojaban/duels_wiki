...
def toc(sections,prefix='',depth=0):
    ...
    for i,s in enumerate(sections,1):
        ...
        out.append(f'<div class="toc-line" style="padding-left:{depth*16}px"><a class="toc-number" href="#{anchor(s.get("id"))}">{n}.</a> <span class="toc-text">{esc(s.get("title","제목 없음"))}</span></div>')
