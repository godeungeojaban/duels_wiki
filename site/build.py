...
.duels-character-card{--duels-card-color:#44aaff;position:relative;display:inline-flex;vertical-align:top;width:138px;min-height:222px;margin:8px 10px 8px 0;padding:12px 8px 10px;flex-direction:column;align-items:center;border:2px solid color-mix(in srgb,var(--duels-card-color) 62%,#34485b);border-radius:4px;background:#0d1015;box-shadow:0 0 8px color-mix(in srgb,var(--duels-card-color) 24%,transparent),inset 0 0 8px rgba(255,255,255,.025);cursor:default;outline:none;transition:transform .15s,background .15s,border-color .15s,box-shadow .15s;user-select:none}.duels-character-card:hover,.duels-character-card:focus{z-index:8;transform:translateY(-3px) scale(1.025);background:#111820;border-color:var(--duels-card-color);box-shadow:0 0 0 1px rgba(255,255,255,.25),0 8px 22px rgba(0,0,0,.48),0 0 18px color-mix(in srgb,var(--duels-card-color) 52%,transparent)}.duels-character-portrait{width:60px;height:60px;flex:0 0 60px;margin:2px auto 8px;border:1.5px solid color-mix(in srgb,var(--duels-card-color) 74%,#8292a0);border-radius:50%;overflow:hidden;background:#091018;display:grid;place-items:center;color:var(--duels-card-color);font-size:23px;font-weight:700}.duels-character-portrait img{width:100%!important;height:100%!important;max-width:none!important;object-fit:cover;object-position:center top;display:block;margin:0!important;border:0!important;transform:none!important}.duels-character-name{width:100%;margin:0 0 4px;color:#dce8f2;font-size:13px;font-weight:700;line-height:1.2;text-align:center;letter-spacing:1.4px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.duels-character-title{width:100%;margin:0 0 7px;color:color-mix(in srgb,var(--duels-card-color) 78%,#dce8f2);font-size:8px;font-weight:700;text-align:center;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.duels-character-mini-stats{width:100%;margin-top:auto;display:flex;flex-direction:column;gap:6px;color:#728394;font-size:11px;line-height:1.3}.duels-character-mini-stats>div{display:grid;grid-template-columns:auto minmax(0,1fr);gap:3px}.duels-character-mini-stats b{color:#91a6b8;font-weight:600}.duels-character-mini-stats span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.duels-character-tooltip{display:none;position:absolute;z-index:20;left:calc(100% + 10px);top:0;width:max-content;max-width:min(520px,calc(100vw - 32px));min-width:280px;padding:8px 12px;border:1px solid #2a4a6a;border-radius:4px;background:#0d1520;color:#778;font-size:11px;line-height:1.5;text-align:left;white-space:normal;overflow-wrap:anywhere;word-break:keep-all;box-shadow:0 8px 28px rgba(0,0,0,.55),0 0 12px color-mix(in srgb,var(--duels-card-color) 30%,transparent);pointer-events:none}.duels-character-card:hover .duels-character-tooltip,.duels-character-card:focus .duels-character-tooltip{display:block}.duels-character-tooltip-title{margin:0 0 6px;color:var(--duels-card-color);font-weight:800;font-style:italic;letter-spacing:.3px}.duels-character-tooltip-desc{margin-bottom:11px;color:#7a8998}.duels-character-tooltip-stats{margin-bottom:11px;color:#697889;white-space:nowrap}.duels-character-tooltip-stats b{color:#8b99a8;font-weight:700}.duels-character-tooltip-stats span{display:inline-block;width:18px}.duels-character-tooltip-skills{margin-top:7px;color:#7b8795;line-height:1.55}.duels-description-box{--duels-box-color:#44aaff;position:relative;margin:12px 0;border:1px solid #2a4a6a;border-left:2px solid var(--duels-box-color);border-radius:3px;background:linear-gradient(180deg,#0d1520,#091019);box-shadow:0 8px 24px rgba(0,0,0,.34),0 0 12px color-mix(in srgb,var(--duels-box-color) 12%,transparent);color:#7a8998;font-size:11px;line-height:1.55;text-align:left}.duels-description-box-title{padding:8px 12px 7px;border-bottom:1px solid #1d3042;color:var(--duels-box-color);font-weight:700;letter-spacing:1.4px;text-shadow:0 0 8px color-mix(in srgb,var(--duels-box-color) 34%,transparent)}.duels-description-box-body{padding:10px 12px 11px;color:#7b8795;overflow-wrap:anywhere;word-break:keep-all}
@media(max-width:720px){.duels-character-card{margin-right:6px}.duels-character-tooltip{left:50%;top:calc(100% + 8px);transform:translateX(-50%);min-width:min(300px,calc(100vw - 28px));max-width:calc(100vw - 28px)}.duels-description-box{max-width:100%}}
@media(max-width:420px){.duels-character-card{width:132px;min-height:214px;padding-left:7px;padding-right:7px}.duels-character-tooltip{min-width:calc(100vw - 20px);max-width:calc(100vw - 20px)}}
'''
